import fs from 'fs';
import type { ResponseLike } from 'stainless-project1/internal/to-file';
import { toFile } from 'stainless-project1/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('stainless-project1/core/uploads');
    await expect(
